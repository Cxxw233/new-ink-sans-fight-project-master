a += 1
draw_sprite_ext(battleextrablue_3, 0, (320 + dx), ((158 + qs) + dy), 1, 1, 0, c_white, 1)
if (ca == 1)
{
    if (md == 0)
    {
        if instance_exists(bo)
    ...
    draw_sprite_ext(battleextrablue_2, 1, (((320 + dx) + 115) - 145), ((((14 + (sin((a / 10)) * 3)) + qs) + dy) + 108), 1, 1, 0, c_white, 1)
}
else
    draw_sprite_ext(battleextrablue_2, 0, (((320 + dx) + 115) - 145), ((((14 + (sin((a / 10)) * 3)) + qs) + dy) + 108), 1, 1, 0, c_white, 1)
draw_sprite_ext(battleextrablue_1, 0, (320 + dx), (((34 + (sin((a / 10)) * 5)) + qs) + dy), 1, 1, 0, c_white, 1)
draw_sprite_ext(battleextrablue_4, -1, (320 + dx), (((54 + (sin((a / 10)) * 5)) + qs) + dy), 1, 1, 0, c_white, 1)

...
if (dir == 270)
    ...
    image_angle = 90
part_emitter_region(global.se, snow, (x - 20.8), (x + 20.8), (y - 20.8), (y + 20.8), 0, 2)
part_emitter_burst(global.se, snow, global.se_type_snow, -1)
if(Battle_GetState()==BATTLE_STATE.IN_TURN && moveable){
    ...
    var b = position_meeting((x + xx), (y + yy), bz)
    var input = -1
    if (dir == 270)
        input = 0
    else if (dir == 90)
    ...
    if ((a || b) && move >= 0)
    {
        ...
        if (dir == 270)
            ...
            fx = (sprite_height / 2)
        while (position_meeting((x + fx), (y + fy), block) || position_meeting((x + fx), (y + fy), bz))
        {
            var mx = 0
            var my = 0
            if (dir == 270)
        ...
        if (position_meeting((x + xx), (y + yy), block) || position_meeting((x + xx), (y + yy), bz))
        {
            move = 0
            if impact
            {
            ...
            if position_meeting((x + xx), (y + yy), bz)
            {
                var cx = 0
                var cy = 0
                if (dir == 270)
                    ...
                    cx = ((sprite_height / 2) + 1)
                var inst = instance_position((x + cx), (y + cy), bz)
    ...
    repeat (abs(move) * 10)
    {
        ...
        if (!position_meeting((x + xx), (y + yy), block))
            var m = (!(move > 0 && position_meeting((x + xx), (y + yy), bz)))
        else
            m = 0
        if m
        {
